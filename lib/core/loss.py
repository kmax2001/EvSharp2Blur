...
class MultiLossFactory(nn.Module):
    def __init__(self, cfg):
        ...
        self.pseudo_label_loss = torch.nn.MSELoss() if cfg.LOSS.SEMI_SUP else None

    def forward(self, output, poffset, heatmap, mask, offset, offset_w, pseudo_label= None):
