...
def main_worker(
    ...
    model = eval('models.'+cfg.MODEL.NAME+'.get_pose_net')(
        cfg, modality= cfg.DATASET.DOMAIN_MODALITY.SOURCE+cfg.DATASET.DOMAIN_MODALITY.TARGET, is_train=True
    )
    ...
    for epoch in range(begin_epoch, cfg.TRAIN.END_EPOCH):
        ...
        # train one epoch
        perf_indicator= do_train(cfg, model, train_loader, loss_factory, optimizer, epoch,
